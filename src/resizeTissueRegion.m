function [basalLayer,apicalLayer,lateralLayer,labelledImage_realSize]=resizeTissue(segmentedPath,fileName,correctLabelledImage)

if exist(fullfile(segmentedPath, 'realSizeCroppedLayer.mat'), 'file') == 0
...
basalLayer = basalLayer.*labelledImage_realSize;    
    ...
    save(fullfile(segmentedPath,'realSizeCroppedLayer.mat'), 'labelledImage_realSize','apicalLayer','basalLayer','lateralLayer', '-v7.3');
    
else
    load(fullfile(segmentedPath, 'realSizeCroppedLayer.mat'))
end
