...
%         cells3dFeatures = [cells3dFeatures; horzcat(oneCell3dFeatures, table(aspectRatio, sphericity, irregularityShapeIndex))];
cells3dFeatures = [cells3dFeatures; horzcat(oneCell3dFeatures, table(aspectRatio))];
    end
end
